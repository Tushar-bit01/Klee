...
const SongsCard = ({ image1, image2,song1,song2,songName1,songName2,artist1,artist2 }) => {
      ...
      <div className=" card-item lg:w-1/2 w-full  h-full rounded-[9vh] overflow-hidden relative group flex flex-col gap-0.5 bg-white border-2 border-black ">
        ...
        <div className=" h-[18%] w-full px-10 py-2 flex justify-between ">
          ...
          <div className=" w-[55%] h-full  flex justify-end   ">
            ...
            {isPlaying1?<img src={Pause} onClick={togglePlay1} className="lg:h-full h-[90%] cursor-pointer"/>:<img onClick={togglePlay1}  src={Play}  className="lg:h-full h-[90%] cursor-pointer"/>}
      ...
      <div className=" card-item lg:w-1/2 w-full  h-full rounded-[9vh] overflow-hidden relative group flex flex-col gap-0.5 bg-white border-2 border-black ">
        ...
        <div className=" h-[18%] w-full px-10 py-2 flex justify-between ">
          ...
          <div className=" w-[55%] h-full  flex justify-end   ">
            ...
            {isPlaying2?<img src={Pause} onClick={togglePlay2} className="lg:h-full h-[90%] cursor-pointer"/>:<img onClick={togglePlay2}  src={Play}  className="lg:h-full h-[90%] cursor-pointer"/>}
